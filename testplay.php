...
<html>
	...
	<title>Audio-Thirst.com #TotalSlaughter</title>
...
$get = file_get_contents('TotalSlaughter.xml');
...
<div id="musicinfo">
	...
	<span>Released: <?php echo $year; ?></span>
	<br />
	<br />
	<span>Genre: <?php echo $genre; ?></span>
	<br />
	<br />
	<span> <?php echo $indexCount; ?> Tracks Found</span>
	<br />
	
	<span><?php echo '<a href="/download.php?file=downloads/' .$dl. '">[Download]</a><br />'; ?></span>
	</div>
...
<tr>
 ...
 <th abbr="Title">Artist</th>
 <th abbr="Download" class="nobg">Download</th>
</tr>
