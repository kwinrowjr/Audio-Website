...
<body>	
	...
	<div id='wrapper' class='clearfix'>
		...
		$query = mysqli_query($db, "SELECT DISTINCT year FROM post_data ORDER BY year ASC LIMIT 900") or die (mysqli_error());
...
$(".closeBox").click(endBlackout); // close if close btn clicked
	...
	<?php 
		...
		echo '<a href="musicplay.php?tape=' . $row['entry'] . '">[Play]</a>'; 
		echo"</div>"; 
...
<center>
	...
	<img style='height:50px; width:988px;' src='/style/pagedivider.png' />
	<div id="adbox">
		<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
		<!-- middlead -->
		<ins class="adsbygoogle"
	...
	<div id="mainbox1">
		...
		<?php 
			...
			$query = mysqli_query($db, "SELECT DISTINCT artist, image FROM post_data ORDER BY RAND() LIMIT 15");
