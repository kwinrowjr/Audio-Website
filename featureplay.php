...
<html>
	...
	<title>Audio-Thirst.com TotalSlaughter Rap Battles</title>
	<meta name="description" content=" Total Slaughter"/>
	<meta name="keywords" content="Total Slaughter, Joe Budden, Hollow Da Don, Murda Mook, Loaded Lux, Rap, Battles"/>
	...
	<link rel="stylesheet" href="/style/featuretable.css" type="text/css"/>
...
$query = mysqli_query($db, "SELECT year, genre, artist, title, image, download, playlist FROM post_data WHERE entry='TotalSlaughter'") or die (mysqli_error());
...
$get = file_get_contents('playlist/TotalSlaughter.xml');
...
?>
	...
	<br /> 
	<br /> 
	<h2>#TotalSlaughter (1-12-2014)</h2>
	<br />
	<div class='featurepic'>
	<img border="0" src="/style/total-slaughter.jpg" alt="logo" width="610" height="405">
	</div>
...
<tr>
 <th abbr="Title">#TotalSlaughter Rap Battles (1-12-2014)</th>
  ...
  function UnMuteNow(){
	...
	var download = <?php echo json_encode($dirArray); ?>; 
	 for (var b = 0; b < download.length; b++){
		...
		var index = b;
		document.write( '<tr><td><a href="#"  onclick="play( \''  + index + '\');">'+ title[index] +'</a></td></tr>'); 		
		}   
